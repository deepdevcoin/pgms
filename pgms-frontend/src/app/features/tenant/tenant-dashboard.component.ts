...
@Component({
  ...
  <section class="fade-up" data-testid="tenant-dashboard">
    ...
    <div class="empty-state card">
      ...
      <div>
        <div class="t">More tenant features coming soon</div>
        <div class="s">Rent payments, complaints, amenity bookings and menu view will be available shortly.</div>
      </div>
    </div>
  </section>
  `,
...
export class TenantDashboardComponent {
    ...
    constructor() { this.api.tenantProfile().subscribe({ next: p => this.profile.set(p) }); }
}