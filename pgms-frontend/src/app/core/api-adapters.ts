...
export function mapTenant(source: unknown): Tenant {
  return {
    ...
    kycDocType: text(source, ['kycDocType'], ''),
    kycDocPath: text(source, ['kycDocPath'], ''),
    kycStatus: enumValue(source, ['kycStatus'], ['NOT_SUBMITTED', 'SUBMITTED', 'REPLACEMENT_REQUESTED', 'VERIFIED'] as const, 'NOT_SUBMITTED'),
    kycSubmittedAt: text(source, ['kycSubmittedAt'], ''),
    kycVerifiedAt: text(source, ['kycVerifiedAt'], ''),
    kycVerifiedByName: text(source, ['kycVerifiedByName'], ''),
    kycReplacementNotes: text(source, ['kycReplacementNotes'], ''),
    kycReplacementRequestedAt: text(source, ['kycReplacementRequestedAt'], ''),
    kycReplacementRequestedByName: text(source, ['kycReplacementRequestedByName'], ''),
